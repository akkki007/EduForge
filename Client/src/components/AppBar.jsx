...
import EduForge from "./SitemarkIcon";
...
export default function AppAppBar() {
  ...
  const playgroundButtonRef = React.useRef(null);

  React.useEffect(() => {
    // Add hover animation to the Playground button
    const button = playgroundButtonRef.current;
    ...
    >
      <Container maxWidth="lg">
        <StyledToolbar variant="dense" disableGutters>
          ...
          >
            <EduForge />
            <Box className="mx-20" sx={{ display: { xs: "none", md: "flex" } }}>
